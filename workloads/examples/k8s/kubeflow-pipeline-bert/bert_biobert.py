...
def bert_pipeline(model_type,
    ...
    checkpoint_steps, skip_download, skip_pretrain):
    ...
    with dsl.Condition(model_type == 'bert'):
        with dsl.Condition(skip_download == '', name='skip-downloads'):
        ...
        with dsl.Condition(skip_pretrain == '', name='skip-pretraining'):
        ...
        with dsl.Condition(task_type == 'squad', name='finetune-squad'):
        ...
        with dsl.Condition(task_type == 'glue', name='finetune-glue'):
